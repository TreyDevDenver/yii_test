...
/**
 * This is the model class for table "checkins".
 *
 * The followings are the available columns in table 'checkins':
 * @property integer $id
 * @property integer $user_id
 * @property integer $num_points
...
class Checkin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, num_points, created_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('num_points',$this->num_points);
